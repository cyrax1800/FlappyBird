 ...
 */	
	final public class PropTween {
		...
		public var c:Number;
		/** Indicates whether or not the target's property that is being tweened is a function _anonymous_comGreensockCore_directly_l25(true) or not (false). If it's a function, it must be set with t.p(value) rather than t.p = value. **/
