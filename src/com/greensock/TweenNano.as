...
TweenNano.ticker.removeEventListener("tick", myFunction);
		...
		public static var defaultEase:Object =  function _anonymous_comGreensock_adds_l243(t:Number, b:Number, c:Number, d:Number):Number {
													return -1 * (t /= d) * (t - 2);
												}
		/** @private **/
...
function myFunction(param1, param2) {
	//do stuff
		 ...
		 * @param params An Array of parameters to pass the function _anonymous_comGreensock_adds_l595(optional).
		 ...
		 * the same function _anonymous_comGreensock_adds_l638(as well as a <code>delay</code> of course).</p>
		 * 
