 ...
 */	 
 ...
 TweenLite.ticker.removeEventListener("tick", myFunction);
		 ...
		 * Modified
		 */
		public var notPausable:Boolean = false;
		 ...
		 */
		public function TweenLite(target:Object, duration:Number, vars:Object, notPausable:Boolean = false) {
			this.notPausable = notPausable;
			super(duration, vars);
...
TweenLite.to([mc1, mc2, mc3], 1, {x:100});
		 ...
		 * @see #fromTo()
		 */
		public static function to(target:Object, duration:Number, vars:Object, notPausable:Boolean = false):TweenLite {
			return new TweenLite(target, duration, vars, notPausable);
		}
...
function myFunction(param1, param2) {
    //do stuff
		 ...
		 * @param params An Array of parameters to pass the function _anonymous_comGreensock_TweenLite_l1071(optional).
		 ...
		 */
		public static function delayedCall(delay:Number, callback:Function, params:Array=null, notPausable:Boolean=false, useFrames:Boolean=false):TweenLite {
			return new TweenLite(callback, 0, {delay:delay, onComplete:callback, onCompleteParams:params, onReverseComplete:callback, onReverseCompleteParams:params, immediateRender:false, useFrames:useFrames, overwrite:0}, notPausable);
		}
...
TweenLite.set([obj1, obj2, obj3], {x:100, y:50, alpha:0});
		 ...
		 * the same function _anonymous_comGreensock_TweenLite_l1151(as well as a <code>delay</code> of course).</p>
		 * 
